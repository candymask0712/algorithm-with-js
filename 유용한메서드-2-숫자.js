...
// ! 큰숫자(BigInt)
// BigInt(숫자) - 변환
// Number(빅인트로변환된변수) - 다시 일반 숫자화
// 빅인트는 빅인트끼리만 계산 가능

// ! 내림/올림
// Math.round(2.5) → 3 ✓ / Math.round(-2.5) → -2 ✓ (0.5 경계는 +∞ 방향)
// Math.ceil(2.1) → 3 ✓ / Math.ceil(-2.9) → -2 ✓ (+∞ 방향)
// Math.floor(2.9) → 2 ✓ / Math.floor(-2.1) → -3 ✓ (-∞ 방향)
// Math.trunc(2.9) → 2 ✓ / Math.trunc(-2.9) → -2 ✓ (0 방향)